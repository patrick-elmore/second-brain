...
// Write candidates.md (format matches Prompts/aliases.md exactly)
var md = new StringBuilder();
md.AppendLine("# Entity Expansion Map");
md.AppendLine();
md.AppendLine("Generated by SecondBrain.AliasMiner. Review and edit before promoting:");
md.AppendLine("  cp <output-dir>/candidates.md src/SecondBrain.Llm/Prompts/aliases.md");
md.AppendLine();
...
static class MinerPrompts
{
    public const string System = """
        ...
        [
          ...
          { "canonical": "Jane Public", "aliases": ["Anthony", "jane.public"],
